...
%Requaires presurfer and bm4d.m from the following repository to be added to MATLAB path. https://github.com/fluese/reconstructionPipeline (see the references in README). 
%Also, Freesurfer must be installed in your system. 
