...
N_layers = [20 10]; % 20 bins between the inner and outer surfaces of the hippocampus are generated and another 10 bins are extended beyond the inner surface to cover SRLM.
N_run = 8;
...
for m = 1:length(folders_comb)
    cd(folders_comb{m,1})
    subject_id = m + 1; % start with 2nd subject
